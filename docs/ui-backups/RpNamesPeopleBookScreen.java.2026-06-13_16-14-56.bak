...
public final class RpNamesPeopleBookScreen extends Screen {
    ...
    private static final int COL_BG = 0xF0101014;
    private static final int COL_PANEL = 0xFF1E1E24;
    ...
    private int editW() {
        boolean preview = previewVisible();
        int right = preview ? previewX() - 8 : panelX() + panelW() - 8;
        return right - editX();
    }
